...
A live demo of the project is available at [https://bokepind.pages.dev](https://bokepind.pages.dev/).
...
1. Fork the [repository](https://torinturi/bokepind/fork) on GitHub.
